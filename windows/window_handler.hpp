...
//                    logViewer->addLog("File size has changed: %ld -> %ld - [ %ld ]\n", lastSize, currentSize, currentSize - lastSize);
...
//                                printf("Line %d: %s\n", line_count, lines[line_count].c_str());
                                newLogLine(logViewer, lines[line_count].c_str());
                                line_count++;
                            }
                            if(buf[cnt] == '\u0000') {
                                break;
        ...
        void credits_window() {
            static bool creditsWindows = true;
        ...
        void live_logs() {
            ...
            if(!once){
                ...
                pthread_t thr;
                pthread_create( &thr, NULL, watch_thread, &logViewer);
            }
    ...
    void new_frame(GLFWwindow* window) {
        ...
        if (ImGui::Begin("window_name")) {
            ImGui::SetCursorPos(ImVec2(309,37.5));
